...
class VariantSelects extends HTMLElement {
  ...
  updateOptions() {
    ...
    var altHandle = $(this).find("option:selected").attr("data-value");
    if(altHandle != ''){
       ...
       $(".itg_thumbnail li.thumbnail-list__item .global-media-settings").removeAttr('aria-current');
        ...
        var variant_title = $(this).find("option:selected").attr("value");
        var varinat_sku = $(this).find("option:selected").attr("var_sku");
